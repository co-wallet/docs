...
`replacement.blockers` содержит количества по причинам `foreign_members`, `external_transactions`, `foreign_authors`,
...
Общие счета (включая мягко удалённые), членство в чужих счетах и их история сохраняются.
Их названия учитываются при подборе свободных имён новых счетов. Другие участники
удаляемых личных счетов, чужие авторы/доли в удаляемой истории и переводы между
удаляемыми и сохраняемыми счетами блокируют замену. Удаление безвозвратно, резервные копии и архивы не
